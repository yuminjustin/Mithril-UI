...
(function (global, factory) { // eslint-disable-line
	...
	function routeByValue(root, router, path) {
		...
		if (index !== -1) {
			...
			/*###router拓展 异步按需加载###*/
			if (router.intermediary) {
				router.intermediary(path, function (comp, params) {
					params && (function () {
						for (var i in params) {
							routeParams[i] = params[i];
						}
					})();
					m.mount(root, comp);
				});
	...
	function handleJsonp(options) {
		...
		/*###添加超时###*/
		(options.timeout) && (timer = setTimeout(script.onerror, options.timeout))
	}
